...
int main(int argc, char **argv)
{
  ...
  CUDA_RUNTIME(cudaMalloc((void **)&Drow_duals, nprob * user_n * sizeof(data)));
  CUDA_RUNTIME(cudaMalloc((void **)&Dcol_duals, nprob * user_n * sizeof(data)));
  ...
  CuLAP TLAP(user_n, nprob, 0, false);
  t.reset();
